 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \App\Auth\JwtGuard $instance */
         ...
         * 
         *
         * @return \App\Auth\Authenticatable|null 
         * @static 
         */ 
         ...
         * 
         *
         * @param \App\Auth\array<string,  string> $credentials
         * @return bool 
         * @static 
         */ 
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\ResponseServiceProvider::register()
         * @param mixed $data
         * @param bool $success
         * @param int $status
         * @param array $headers
         ...
         * @static 
         */ 
        public static function standard($data = [], $success = true, $status = 200, $headers = [], $options = 0)
        {
                        return \Illuminate\Routing\ResponseFactory::standard($data, $success, $status, $headers, $options);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function success($data = [], $status = 200, $headers = [], $options = 0)
        {
                        return \Illuminate\Routing\ResponseFactory::success($data, $status, $headers, $options);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function error($data = [], $status = 400, $headers = [], $options = 0)
        {
                        return \Illuminate\Routing\ResponseFactory::error($data, $status, $headers, $options);
        }
